<html>
	...
	<div id="//hotels/international" style="position: relative; top: 5px; min-height:1000px; flex:0; border-radius: 5px; overflow:hidden; overflow-y: auto; background-color:#111; font-family:Quicksand; background-repeat: no-repeat;">
		...
		<div style="margin-left:20px; margin-right: 20px; background-color: rgba(30,30,30,1.0); height: 100%; position:relative; top: 40px; height: 800px; padding: 10px;">
				...
				<div style="background-color: #2b2b2b; margin-top: 10px; min-height:70px; padding: 20px;">

                                        <div style="background-color: #2b2b2b; min-height:70px; padding: 20px; ">

                                                <i class="fas fa-angle-down" style="font-size: 20px;"></i><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:20px;'>&nbsp;
Search C/C++ sourcecode:</p>
                                                        ...
                                                        <div style="display: flex; padding: 10px; margin:10px; flex-direction: column;">
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                                                                                ...
                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; Keyword(s):

                                                                        </div>

                                                                        <div style="border-radius: 5px; height: 20px; flex:8;  margin: 10px; padding: 5px;">

                                                                                <input type="text" name="c_source_keyword"></input>
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:0 0 175px; background-color: #222; margin: 10px; padding: 5px;">

                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; 3rd party sites(s):

                                                                        </div>

                                                                        <div style="border-radius: 5px; height: 20px; flex:0 0 200px;  margin: 10px; padding: 5px; background-color:#202020;">
										...
										Github.org
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:0 0 175px; background-color: #222; margin: 10px; padding: 5px;">
                                                                                ...
                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; Save source to file folder:

                                                                        </div>

                                                                        <div style="background-color: #202020; border-radius: 5px; height: 20px; flex:0 0 200px; margin: 10px; padding: 5px;">
										...
										* MyFileFolder1
                                                                        ...
                                                                        <div style="background-color: #456; border-radius: 5px; height: 20px; flex:0 0 200px; margin: 10px; padding: 5px;">

                                                                                New file folder<i class="fas fa-unlock" style="padding-left:105px;"></i>
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                                                                                ...
                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; Report old/broken source:
							...
							<input type="submit" class="button" style="width: 175px; margin-left: 50px; margin-top: 50px;">
				...
				<div style="background-color: #2b2b2b; margin-top: 10px; min-height: 70px; padding: 20px;">
					...
					<div style="background-color: #2b2b2b; min-height:70px; padding: 20px; ">
						...
						<i class="fas fa-angle-down" style="font-size: 20px;"></i><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:20px;'>&nbsp;Search settings:</p>
						...
						<form style="" style="">
							...
							<div style="display: flex; padding: 10px; margin:10px; flex-direction: column;">
								...
								<div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
									...
									<div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
										...
										<i class="fab fa-cloudsmith"></i>&nbsp; Design team:

									</div>

									<div style="border-radius: 5px; height: 20px; flex:8;  margin: 10px; padding: 5px;">

										<input type="text" name="c_design_team"></input>									
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                	                                                        ...
                	                                                        <i class="fab fa-cloudsmith"></i>&nbsp; License:

									</div>

                	                                                <div style="border-radius: 5px; height: 20px; flex:8; margin: 10px; padding: 5px;">
		
        	                                                                <input type="text" name="c_license"></input>
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                        	                                                ...
                        	                                                <i class="fab fa-cloudsmith"></i>&nbsp; Max. size:

									</div>

                                                                	<div style="border-radius: 5px; height: 20px; flex:8; margin: 10px; padding: 5px;">

                                                                        	<input type="text" name="c_max_size"></input>
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                                                                                ...
                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; Design engine:

                                                                        </div>

                                                                        <div style="border-radius: 5px; height: 20px; flex:8; margin: 10px; padding: 5px;">

                                                                                <select type="select" name="c_design_engine" style="width: 175px;" class="sprug_select">

											<option name="servlet">Servlet</option>

                                                                                        <option name="jsp">JSP</option>

                                                                                        <option name="asp">ASP</option>

                                                                                        <option name="apml">APML</option>
                                                                ...
                                                                <div style="flex: 1; display: flex; padding: 10px; margin:10px; flex-direction: row;">
                                                                        ...
                                                                        <div style="border-radius: 5px; height: 20px; flex:1; background-color: #222; margin: 10px; padding: 5px;">
                                                                                ...
                                                                                <i class="fab fa-cloudsmith"></i>&nbsp; Integration engine:
							...
							<input type="button" class="button" style="width: 175px; margin-left: 50px; margin-top: 50px;" value="Integrate">
...
<i class="fas fa-angle-down" style="font-size: 20px; color: #aaa;"></i><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:20px;'>&nbsp;C the language:</p>
