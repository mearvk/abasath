...
<!--	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"> -->
	...
	function respond(event)
	{
		...
		alert( event.className+" "+event.cancelBubble );
	...
	<body class="" style="background-color: #333; margin:0px; padding:0px; background-repeat: no-repeat;">

	<!-- -->

	<div id="header" style="background-colior:#222; height:120px; margin: auto; padding: 10px; box-shadow: 0px 0px 8px #080808; border-radius:5px; border-bottom: black solid 2px; background-image: url('./images/cruise.png'); -webkit-clip-path: circle(70.0% at 50% 0%); background-repeat: no-repeat;">
			...
			<p style="font-family: 'Quicksand'; font-weight: 900; font-size:10px; color: #fff; display: none; text-shadow: 0px 0px 0px #888;">Sprug Research &#8759; Vital Alignment Ahead</p>

			<center>

				<form id="primary" class="form_primary" style="background-color: rgba(30, 30, 30, 0.7); padding: 5px 5px 5px 10px; margin:auto; display:inline-block; text-align: center; position:relative; top:15px; border-radius: 8px;" action="?">
					...
					<input name="search" value="Enter Search Terms" onfocus=this.value="" selected="true" type="text" style="color: #999; margin:auto; padding: 3px; width:800px; font-family: 'Quicksand', sans-serif; font-size:14px; border-radius: 5px; border: none; box-shadow: 5px solid black;">
