		...
		<div style="margin-left:20px; margin-right: 20px; background-color: rgba(30,30,30,1.0); height: 100%; position:relative; top: 40px; height: 800px; padding: 10px;">
				...
				<div style="background-color: #2b2b2b;">
					...
					<div style="background-color: #2b2b2b; min-height:70px; padding: 20px; ">
						...
						<i class="wi wi-night-sleet" style="font-size: 20px; color: #aaa;"><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:20px;'>&nbsp;Search options:</p></i>
						<form style="" style="">
...
<i class="wi wi-night-sleet" style="font-size: 20px; color: #aaa;"><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:20px;'>&nbsp;Local report:</p></i>
