...
<i class="wi wi-night-sleet" style="font-size: 08px; color: #fff; margin: 4px;"><p style='display: inline; font-family:Quicksand; font-weight: 400; font-size:08px; border-radius: 15px 5px 15px 5px;'>&nbsp;local report:</p></i>
