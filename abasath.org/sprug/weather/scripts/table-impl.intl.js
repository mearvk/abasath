...
function build_table()
{
	...
	var list = ['London,UK','Reykjavik','Paris,FR','Mumbai,IN','Sao+Paulo,BR','Beijing,CN','Mexico+City,MX','Osaka,JP','Cairo,EG','New+York,US','Amsterdam,NL','Lyons,FR','Delhi,NC','Tokyo,JP'];
	...
	{
		xmlhttp.open("GET", "https://api.openweathermap.org/data/2.5/forecast?q="+list[a]+"&appid=2d35ec638192fdbd36303125180a98cf", false);
